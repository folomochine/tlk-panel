  <div class="modal fade tl-modal tl-modal--compact" id="modalDiv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
     <div class="modal-content">
       ...
       <div id="modalContent" class="tl-modal-content-zone">
       </div>
     </div>
   </div>
  </div>
  ...
  <div class="modal fade tl-modal tl-modal--compact" id="subsDiv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
     <div class="modal-content">
       <div class="modal-header">
         <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
       ...
       <div id="subsContent" class="tl-modal-content-zone">
       </div>
     </div>
   </div>
  </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.8.1/js/bootstrap-select.js"></script>
  ...
  <script src="public/admin/tl-modal.js"></script>
...
<script type="text/javascript" src="/public/global/rq6gso8oois098nss.js"></script>
...
upload_btn.html('<i class="fa fa-spinner fa-spin" aria-hidden="true"></i> Chargement...');
...
type:"POST",
success: function (response) {
upload_btn.html("Telecharger une image");
upload_btn.removeAttr("disabled");
iziToast.show({

    icon:'fa fa-check',

    title: "Image telechargee avec succes.",
    message: '',
    color:'green',
    position:'topCenter'
});
...
$.toast({ heading: "Succes", text: 'Taux mis a jour.', icon:'success', loader: true, loaderBg: "#9EC600" });
...
success:function(json){
json = JSON.parse(json);
$(".modal-title").html('Dernière réponse du fournisseur<br/><div class="label label-api">'+json.api_url+'</div>');
...
$("#site_currency_btn").html("Définir la devise en "+$ht.replace("(Recommandé pour les utilisateurs internationaux)","").replace("(Recommandé pour les utilisateurs indiens)","")+" ("+$code+")");
});
...
iziToast.show({
    icon:'fa fa-check',
    title: 'Taux de devise mis a jour.',
    message: '',
    color:'green',
    position:'topCenter'
});
