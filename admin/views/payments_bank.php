...
<div class="container-fluid">
   <ul class="nav nav-tabs">
      <li class="<?php if( $status == "all"): echo "active"; endif; ?>"><a href="<?=site_url("admin/payments/bank")?>">Tous les paiements</a></li>
      <li class="<?php if( $status == "pending"): echo "active"; endif; ?>"><a href="<?=site_url("admin/payments/bank/1/pending")?>">Paiements en attente</a></li>
      <li class="<?php if( $status == "completed"): echo "active"; endif; ?>"><a href="<?=site_url("admin/payments/bank/1/completed")?>">Paiements terminés</a></li>
      <li class="<?php if( $status == "canceled"): echo "active"; endif; ?>"><a href="<?=site_url("admin/payments/bank/1/canceled")?>">Paiements annulés</a></li>
      ...
      <li class="pull-right export-li">
         ...
         <span class="export-title">Ajouter/Supprimer des paiements</span>
       </button>
      </li>
   </ul>
   <table class="table">
                 ...
                 <td class="service-block__action">
                   <div class="dropdown pull-right">
                     ...
                     <ul class="dropdown-menu">
                       <li><a href="#"  data-toggle="modal" data-target="#modalDiv" data-action="payment_bankedit" data-id="<?php echo $payment["payment_id"] ?>">Modifier</a></li>
                     </ul>
                   </div>
                 </td>
              </tr>
