    ...
    <div class="panel-body">
        <div class="row settings-menu__row">
                        <div class="col-md-3">
                            ...
                            <div class="settings-menu__description">Visible pour tous les visiteurs</div>
                        </div>
                        <div class="col-md-9">
                            <div class="dd"> 
    <table class="table">
...
<a data-toggle="modal" data-target="#modalDiv" data-action="edit_external" data-id="<?php echo $menu["id"]; ?>"  class="btn btn-default btn-xs dropdown-toggle btn-xs-caret pull-right">Modifier</a>
...
<a data-toggle="modal" data-target="#modalDiv" data-action="add_external" data-id="<?php echo $menu["id"]; ?>"  class="btn btn-default m-b add-modal-menu">Ajouter un élément de menu</a>
             </div>      
</div>   

<div class="row settings-menu__row">
                        <div class="col-md-3">
                            <div class="settings-menu__title">Connecté</div>
                            <div class="settings-menu__description">Disponible pour les utilisateurs connectés</div>
                        </div>
                        <div class="col-md-9" >
                            <div class="dd" >
    <table class="table">
...
<a data-toggle="modal" data-target="#modalDiv" data-action="edit_internal" data-id="<?php echo $menu["id"]; ?>"  class="btn btn-default btn-xs dropdown-toggle btn-xs-caret pull-right">Modifier</a>
</td>
...
<a data-toggle="modal" data-target="#modalDiv" data-action="add_internal" data-id="<?php echo $menu["id"]; ?>"  class="btn btn-default m-b add-modal-menu">Ajouter un élément de menu</a> 
</div>
