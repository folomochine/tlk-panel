    ...
    <div class="new-year__event-wrapper">
        ...
        <div class="new-year__event-body">
            <div class="new-year__event-description">
                        <span>Décoration de fin d'annee</span>
            </div>
								...
								<div class="new-year__settings-group">
									...
									<div class="new-year__settings-label">
										<div class="form-group__switch">
											...
											<label for="snow" class="form-group__switch-label form-group__switch-label-snow">Neige tombante</label>
											
										
									</div>	</div>
									<div class="new-year__settings-form" id="snow_div"  >
										<div class="new-year__settings-row">
											<div class="new-year__settings-row-label"><label class="control-label">Flocons</label>
...
<div class="new-year__settings-row">
<div class="new-year__settings-row-label">Vitesse de chute</div>
<div class="new-year__settings-row-options">
<div role="toolbar" class="btn-toolbar">
...
<option value="3" <?= $decoration["snow_speed"] == 3 ? "selected" : null; ?>>Lent</option>
<option value="5" <?= $decoration["snow_speed"] == 5 ? "selected" : null; ?>>Moyen</option>
<option value="10" <?= $decoration["snow_speed"] == 10 ? "selected" : null; ?>>Rapide</option>
...
<h5 style="color:black;">Couleur de la neige</h5>
...
<div class="new-year__settings-label">
										<div class="form-group__switch">
											...
											<label for="garland" class="form-group__switch-label form-group__switch-label-garland">Guirlandes</label></div>
									</div>
									<div class="new-year__settings-form" id="garland_div"   >
										<div class="new-year__settings-row">
											<div class="new-year__settings-row-label">Forme</div>
											<div class="new-year__settings-row-options">
												<div role="toolbar" class="btn-toolbar">
          ...
          <option value="apple" <?= $decoration["gar_shape"] == "apple" ? "selected" : null; ?>>Cercle</option>
            <option value="pear" <?= $decoration["gar_shape"] == "pear" ? "selected" : null; ?>>Ovale</option>
										...
										<div class="new-year__settings-row">
											<div class="new-year__settings-row-label">Couleurs</div>
											<div class="new-year__settings-row-options">
												<div role="toolbar" class="btn-toolbar">
								...
								<div class="new-year__settings-group">
									<div class="new-year__settings-label">
										<div class="form-group__switch">
											...
											<label for="fireworks" class="form-group__switch-label form-group__switch-label-fireworks">Feux d'artifice</label></div>
									</div>
									<div class="new-year__settings-form" id="fireworks_div" >
										<div class="new-year__settings-row">
											<div class="new-year__settings-row-label">Taille</div>
											<div class="new-year__settings-row-options">
												<div role="toolbar" class="btn-toolbar">
          ...
          <option value="0.95" <?= $decoration["fire_size"] == 0.95 ? "selected" : null; ?>>Petit</option>
            <option value="0.97" <?= $decoration["fire_size"] == 0.97 ? "selected" : null; ?>>Moyen</option>
            <option value="1.02" <?= $decoration["fire_size"] == 1.02 ? "selected" : null; ?>>Grand</option>
										...
										<div class="new-year__settings-row">
											<div class="new-year__settings-row-label">Délai</div>
											<div class="new-year__settings-row-options">
												<div role="toolbar" class="btn-toolbar">
													<div id="fireworks_size" data-toggle="buttons" class="btn-group btn-group-sm btn-group-justified">
														<div class="form-group">
          ...
          <option value="slow" <?= $decoration["fire_speed"] == "slow" ? "selected" : null; ?>>Lent</option>
            <option value="medium" <?= $decoration["fire_speed"] == "medium" ? "selected" : null; ?>>Moyen</option>
            <option value="fast" <?= $decoration["fire_speed"] == "fast" ? "selected" : null; ?>>Rapide</option>
									...
									<div class="new-year__settings-label">
										<div class="form-group__switch">
											...
											<label for="garland" class="form-group__switch-label form-group__switch-label-garland">Jouets</label></div>
									</div>
									<div class="new-year__settings-form" id="toys_div" >
										<div class="new-year__settings-row">
											<div class="toys-select">
												<div class="toys-select__label">Choisir des jouets (max 5)</div>
									...
									<div class="new-year__settings-row">
												...
												<div role="toolbar" class="btn-toolbar">
													<div id="toys_size" data-toggle="buttons" class="btn-group btn-group-sm btn-group-justified">
														<label type="button" class="btn btn-default <?= $decoration["toy_size"] == 30 ? "active" : null; ?>">
															<input name="toy_size" type="radio" value="30" <?= $decoration["toy_size"] == 30 ? "checked='checked'" : null; ?>>Petit
														</label>
														<label type="button" class="btn btn-default  <?= $decoration["toy_size"] == 50 ? "active" : null; ?>">
															<input name="toy_size" type="radio" value="50" <?= $decoration["toy_size"] == 50 ? "checked='checked'" : null; ?>>Moyen
														</label>
														<label type="button" class="btn btn-default <?= $decoration["toy_size"] == 80 ? "active" : null; ?>" >
															<input name="toy_size" type="radio" value="80" <?= $decoration["toy_size"] == 80 ? "checked='checked'" : null; ?>>Grand
														</label>
													</div>
												</div>
											</div>
										...
										<div class="new-year__settings-row">
											<div class="new-year__settings-row-label">Quantité</div>
											<div class="new-year__settings-row-options">
												<div role="toolbar" class="btn-toolbar">
...
<div class="new-year__settings-row-label">Vitesse de chute</div>
												...
												<div role="toolbar" class="btn-toolbar">
													<div id="toys_speed" data-toggle="buttons" class="btn-group btn-group-sm btn-group-justified">
														<label type="button" class="btn btn-default <?= $decoration["toy_speed"] == 1 ? "active" : null; ?>">
															<input name="toy_speed" type="radio" autocomplete="off" value="1" <?= $decoration["toy_speed"] == 1 ? "checked='checked'" : null; ?>>Lent
														</label>
														<label type="button" class="btn btn-default <?= $decoration["toy_speed"] == 3 ? "active" : null; ?>">
															<input name="toy_speed" type="radio" autocomplete="off" value="3" <?= $decoration["toy_speed"] == 3 ? "checked='checked'" : null; ?>>Moyen
														</label>
														<label type="button" class="btn btn-default <?= $decoration["toy_speed"] == 6 ? "active" : null; ?>">
															<input name="toy_speed" type="radio" autocomplete="off" value="6" <?= $decoration["toy_speed"] == 6 ? "checked='checked'" : null; ?>>Rapide
														</label>
													</div>
												</div>
											</div>
										...
										<div class="new-year__settings-row">
											<div class="new-year__settings-row-label">Lancements</div>
											<div class="new-year__settings-row-options">
												<div role="toolbar" class="btn-toolbar">
													<div id="toys_launch" data-toggle="buttons" class="btn-group btn-group-sm btn-group-justified">
														<label type="button" class="btn btn-default <?= $decoration["toy_launch"] == 1 ? "active" : null; ?>">
															<input name="toy_launch" type="radio" autocomplete="off" value="1" <?= $decoration["toy_launch"] == 1 ? "checked='checked'" : null; ?>>Une fois
														</label>
														<label type="button" class="btn btn-default <?= $decoration["toy_launch"] == "infinite" ? "active" : null; ?>">
															<input name="toy_launch" type="radio" autocomplete="off" value="infinite" <?= $decoration["toy_launch"] == "infinite" ? "checked='checked'" : null; ?>>En continu
														</label>
													</div>
												</div>
											</div>
					...
					$('#editDescription').on('show.bs.modal', function(e) {
						...
						xhttp.onreadystatechange = function() 
						{
							...
							if (this.readyState == 4 && this.status == 200) 
							{
								...
								{
									document.getElementById("editdescriptionBody").innerHTML = "<h2>Erreur ! Veuillez recharger la page ou contacter l'administrateur.</h2>";
								}
					...
					//frm.submit(function (ev) {
						$.ajax({
							...
							success: function (data) {
								...
								if (typeof data.status !== 'undefined') {
									if( data.status == 1 ){
										...
										//document.getElementById("demo").innerHTML = '<div class="alert alert-danger alert-dismissible" ><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Erreur. Veuillez contacter l\'administrateur !</strong></div>';
									}
								}else{
									//console.log('no');
									document.getElementById("demo").innerHTML = '<div class="alert alert-danger alert-dismissible" ><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Erreur. Veuillez contacter l\'administrateur !</strong></div>';
							...
							error: function(XMLHttpRequest, textStatus, errorThrown) { 
								...
								document.getElementById("demo").innerHTML = '<div class="alert alert-danger alert-dismissible" ><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Problème de communication. Veuillez actualiser la page et réessayer !</strong></div>';						
								$('#confirmChangeBulk').modal('hide');
							}   
						});
						//ev.preventDefault();
