...
<div class="settings-header__table">
            ...
            <div class="col-md-5">
	<div class="settings-header__table">
		<button type="button" class="btn btn-default m-b" data-toggle="modal" data-target="#modalDiv" data-action="new_provider">Ajouter un fournisseur</button>
	</div>
...
echo '<div class="tooltip5">  <span class="fas fa-info-circle"></span><span class="tooltiptext5">Informations de solde non disponibles pour ce fournisseur</span></div>'  ;
...
<span style="color:var(--blue);" data-toggle="modal" data-target="#modalDiv" data-action="edit_provider" data-id="<?= $provider["id"]?>"><i class="fas fa-edit"></i></span>

<?php if($panel["panel_type"] != "Child" ): ?>
<a style="color:var(--red);display:inline-block;" href="#" data-toggle="modal" data-target="#confirmChange" data-href="<?=site_url("admin/settings/providers/delete/".$provider["id"])?>">
<i class="fas fa-trash"></i>
</a>
<?php endif; ?>

<span data-toggle="modal" data-target="#modalDiv" data-action="capture_description" data-id="<?= $provider["id"]?>" style="display:inline-block;color:var(--orange);">
