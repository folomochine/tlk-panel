...
<div>
  <div class="settings-header__table">
    <a href="<?php echo site_url("admin/settings/language/new") ?>"  class="btn btn-default m-b">Nouvelle langue</a>
  </div>
  <hr>
   <table class="table report-table" style="border:1px solid var(--border)">
      ...
      <tbody>
         ...
         <tr class="<?php if( $language["language_type"] == 1 ): echo 'grey'; endif; ?>">
            <td> <?php echo $language["language_name"]; if( $language["default_language"] == 1 ): echo ' <span class="badge">Par défaut</span>'; endif; ?> </td>
