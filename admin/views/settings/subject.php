...
<div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row settings-menu__row">
                        <div class="col-md-3">
                            <div class="settings-menu__title">Sujets</div>
                            <div class="settings-menu__description">Options de demande de support.</div>
                        </div>
                        <div class="col-md-9">
                            <div class="dd">
                                       ...
                                       <?php foreach($subjectList as $subject): ?>
                                        <li class="dd-item ui-sortable-handle">
                                            ...
                                            <div class="settings-menu__action">
                                                ...
                                                <a href="<?php echo site_url('admin/settings/subject/edit/'.$subject["subject_id"].'') ?>" class="btn btn-default btn-xs edit-modal-menu">Modifier</a>
                                            </div>
                                        </li>
                                        <?php endforeach; ?>
                            ...
                            <a href="javascript:;" onclick="showMe('gizlebeni');" class="btn btn-default m-b add-modal-menu">Créer un nouveau sujet</a>
                        </div>
                    </div>
    ...
    <div class="panel-body">
         ...
         <form action="<?php echo site_url('admin/settings/subject') ?>" method="post" enctype="multipart/form-data">
          ...
          <label for="" class="control-label">Sujet de support</label>
          <input type="text" class="form-control" name="subject">
        </div>
        
<div class="form-group">
               <label class="control-label">Réponse automatique</label>
<select class="form-control" name="auto_reply">
    ...
    <option value="1">Actif</option>
            ...
            <div class="form-group">
               <label class="control-label">Message de réponse automatique</label>
               <textarea class="form-control" rows="5" name="content"></textarea>
            </div>	  
           <p>Réponse automatique lorsqu'une nouvelle demande de support est créée sous ce sujet.</p> 
            <hr>
...
<div>
    <a href="/admin/settings/subject" class="details_backButton btn btn-link"><span>‹</span> Retour</a>
...
<select class="form-control" name="auto_reply">
    ...
    elseif($post["auto_reply"] == 1){echo'selected'; }?>>Désactivé</option>
    <option value="1" <?php if($post["auto_reply"] == 1){echo'selected';}
    elseif($post["auto_reply"] == 1){echo'selected'; }?>>Actif</option>
</select>            </div>	          
