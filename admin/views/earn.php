...
<td class="service-block__action">
      ...
      <?php?>
                              <li><a href="#" data-toggle="modal" data-target="#confirmChange" data-href="<?=site_url("admin/earn/earn_review/".$earn["earn_id"])?>">En cours de verification</a></li>
                            <?php?>
                              <li><a href="#"  data-toggle="modal" data-target="#modalDiv" data-action="earn_note" data-id="<?php echo $earn["earn_id"] ?>">Modifier la note</a></li>
                            <?php ?>
                              <li><a href="#" data-toggle="modal" data-target="#confirmChange" data-href="<?=site_url("admin/earn/earn_grant/".$earn["earn_id"])?>">Fonds accordes</a></li>
                            
                            <?php ?>
                              <li><a href="#" data-toggle="modal" data-target="#confirmChange" data-href="<?=site_url("admin/earn/earn_reject/".$earn["earn_id"])?>">Rejeter</a></li>
